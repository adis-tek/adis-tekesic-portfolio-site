...
function ProjectBreathe() {
    ...
    <motion.div variants={fadeIn} initial="hidden" animate="show">
        <ProjectContainer>
            ...
            <ProjectMain>
                    <Paragraph>Each state was moving at a different pace with their vaccinations. To get a better idea of the progress I decided to fetch data and monitor crucial metrics like new daily cases and the vaccination rate.</Paragraph>
